...
public class HrWsConsumerApp {

	private static final String WS_API = "ws://localhost:7100/hr/api/v1/hr-events";
	
	public static void main(String[] args) throws InterruptedException {
		var listener = new HrWebSocketListener();
		HttpClient.newHttpClient()
			      .newWebSocketBuilder()
				  .buildAsync(URI.create(WS_API), listener);
...
class HrWebSocketListener implements Listener {
	...
	public void onOpen(WebSocket webSocket) {
		System.out.println("Connected to the ws server.");
